...
SNAPSHOT = Path(
    "/Users/daniel.tipton/Desktop/An app/.cache/huggingface/hub/"
    "models--google--gemma-3-4b-it/snapshots/093f9f388b31de276ce2de164bdc2081324b9767"
)
...
def main():
    ...
    if args.output.exists():
        parser.error("output exists; preserve prior measurement records")
    ...
    for length in (64, 1400):
        ...
        def broken(ids, cache=None, original=original):
        ...
        observed.append(
            {
                "tokens": length,
                "normal_max_abs_by_layer": normal,
    ...
    controls = [
        decode_readout_probe(view, [1, 5, 9, 3], steps=3, control=control)
    ...
    report = {
        ...
        "full_checkpoint_gates_2_3_4": "unexecuted",
        "cuda": "unexecuted",
    ...
    print(
        json.dumps(
            {
                "small_model_gate2": observed,
                "readout_max_error": tolerance,
                "full_model_meta": full_structure,
